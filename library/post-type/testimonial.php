...
function testimonial_post_type() { 
	...
	register_post_type( 'testimonial', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array( 
			'labels' => array(
				'name' => __( 'Testimonials', 'ptheme' ), /* This is the Title of the Group */
				'singular_name' => __( 'Testimonial', 'ptheme' ), /* This is the individual type */
				'all_items' => __( 'All Testimonials', 'ptheme' ), /* the all items menu item */
				'add_new' => __( 'Add New', 'ptheme' ), /* The add new menu item */
				'add_new_item' => __( 'Add New Testimonial', 'ptheme' ), /* Add New Display Title */
				'edit' => __( 'Edit', 'ptheme' ), /* Edit Dialog */
				'edit_item' => __( 'Edit Testimonial', 'ptheme' ), /* Edit Display Title */
				'new_item' => __( 'New Testimonial', 'ptheme' ), /* New Display Title */
				'view_item' => __( 'View Testimonial', 'ptheme' ), /* View Display Title */
				'search_items' => __( 'Search Testimonials', 'ptheme' ), /* Search Custom Type Title */ 
				...
				'parent_item_colon' => '',
				'delete_posts' => 'Delete Testimonials'
			), /* end of arrays */
			'description' => __( 'Manage the testimonials listed on the site.', 'ptheme' ), /* Custom Type Description */
			'public' => true,
...
function the_testimonials() {
    ...
    $args = array( 'post_type' => 'testimonial', 'posts_per_page' => 30 );
	$args[ 'orderby' ] = 'rand';
